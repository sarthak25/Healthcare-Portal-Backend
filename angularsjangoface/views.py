...
def recognize():
    ...
    recognizer.read('angularsjangoface\\package\\trainer\\trainer.yml')
    cascadePath = "angularsjangoface\\package\\Classifiers\\face.xml"
    ...
    with open('angularsjangoface\package\hash_faces.txt', 'r') as file:
        for line in file:
