...
def recommend(request):
    ...
    psymptoms = json.loads(request.body)['dstr']
    print(psymptoms)
    ...
    df=pd.read_csv("appApi/recomend/Training.csv")
    ...
    tr=pd.read_csv("appApi/recomend/Testing.csv")
